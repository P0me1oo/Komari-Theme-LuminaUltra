...
LuminaUltra **v1.6.5** 修复手机端顶部快捷栏提前换行的问题，按实际按钮数量和可用宽度调整间距与尺寸，保持单行显示。继续保留顶部资产入口、访客信息卡片居中与双列布局，以及香港、台湾、澳门的位置名称修复。基于已同步的 [LuminaPlus v1.3.2](https://github.com/shanyang242/Komari-Theme-LuminaPlus/releases/tag/v1.3.2)，完整变更见 [v1.6.5 更新说明](.github/release-notes/v1.6.5.md)。
