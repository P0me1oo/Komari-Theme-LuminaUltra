import { canViewCosts, type ResolvedThemeSettings } from "@/utils/themeSettings";

type AssetsAccessSettings = Pick<
  ResolvedThemeSettings,
  "showCostSummary" | "showCostSummaryFloatingButton" | "showCostsToGuests"
>;
...
export function canAccessAssets(settings: AssetsAccessSettings, loggedIn: boolean): boolean {
  return (
    ...
    canViewCosts(settings, loggedIn)
  );
}
